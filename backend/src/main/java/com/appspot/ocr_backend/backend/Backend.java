...
public class Backend extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
    ...
    public class Reading {
         ...
         * <p/>
         * Create a request for the method "reading.new".
         * <p/>
         * This request holds the parameters needed by the backend server.  After setting any optional
         * parameters, call the {@link BackendNew#execute()} method to invoke the remote operation.
         *
         ...
         * @return the request
         */
        public BackendNew backendNew(com.appspot.ocr_backend.backend.model.MessagesNewReading content) throws java.io.IOException {
            BackendNew result = new BackendNew(content);
            initialize(result);
            return result;
        }

        public class BackendNew extends BackendRequest<com.appspot.ocr_backend.backend.model.MessagesNewReadingResponse> {

            private static final String REST_PATH = "reading/new";
             ...
             * @since 1.13
             */
            protected BackendNew(com.appspot.ocr_backend.backend.model.MessagesNewReading content) {
